...
$query = "SELECT * FROM `projects` WHERE `catego` LIKE 'Articles In Refereed' and `display` like 'yes' and `Categories` like 'Circular Security'";
...
$query1 = "SELECT * FROM `projects` WHERE `catego` LIKE 'Technical Reports' and `display` like 'yes' and `Categories` like 'Circular Security'";
...
?>
    ...
    <!-- Page header -->
    <div class="elh-page-header elh-img-bg elh-bg-circular-security">
